...
class StoreListViewAdapter : RecyclerView.Adapter<StoreListViewAdapter.ViewHolder>() {
    ...
    var data: List<info.nukoneko.cuc.android.kidspos.model.entity.Store> = emptyList()
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): ViewHolder {
        ...
        return ViewHolder(binding, object : ViewHolder.Listener {
            override fun onItemClick(store: info.nukoneko.cuc.android.kidspos.model.entity.Store) {
    ...
    interface Listener {
        fun onStoreSelect(store: info.nukoneko.cuc.android.kidspos.model.entity.Store)
    }
    ...
    class ViewHolder(private val binding: ItemStoreListBinding, listener: Listener?) : RecyclerView.ViewHolder(binding.item) {
        ...
        init {
            this.listener = object : ItemStoreListContentViewModel.Listener {
                override fun onStoreSelected(store: info.nukoneko.cuc.android.kidspos.model.entity.Store) {
                    listener?.onItemClick(store)
                }
            }
        }

        fun bind(store: info.nukoneko.cuc.android.kidspos.model.entity.Store) {
        ...
        interface Listener {
            fun onItemClick(store: info.nukoneko.cuc.android.kidspos.model.entity.Store)
        }
    }
}
